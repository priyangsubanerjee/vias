...
export default function Home() {
  return (
    <main className="font-general-sans">
      <div className="flex flex-col-reverse lg:flex-row lg:h-[700px] pb-24 lg:pb-[100px] px-6 py-[30px] lg:px-[96px] lg:py-[90px] bg-[#D7F3FF]">
          ...
          <ul className="mt-10 space-y-6 text-sm font-medium">
            <li className="flex space-x-2">
              ...
              <span className="leading-6">
                Wide range of kitchen cabinet styles to suit various design
                preferences, including modern, traditional, transitional, and
                more.
              </span>
            </li>
            <li className="flex space-x-2">
              ...
              <span className="leading-6">
                Cabinets crafted from high-quality materials, ensuring
            ...
            <li className="flex space-x-2">
              ...
              <span className="leading-6">
                Competitive pricing to accommodate various budget constraints.
              </span>
            </li>
            <li className="flex space-x-2">
              <svg
              ...
              <span className="leading-6">
                Fast and reliable shipping for a hassle-free cabinet delivery.
              </span>
            </li>
            <li className="flex space-x-2">
              <svg
              ...
              <span className="leading-6">
                Dedicated customer support team ready to assist with inquiries
                and concerns.
              </span>
            </li>
            <li className="flex space-x-2">
              ...
              <span className="leading-6">
                Comprehensive warranty coverage to provide peace of mind.
              </span>
            </li>
          </ul>
