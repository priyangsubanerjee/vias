            ...
            <div className="grid grid-cols-1 place-content-center lg:grid-cols-3 gap-4 mt-8">
              <div className="border-[3px] border-[#C3C3C3] rounded-2xl overflow-hidden">
                ...
                <div className="p-5 bg-white">
                  ...
                  <h2 className="mt-3 font-medium text-[#222]">
                    Weston White Shaker
                  </h2>
                  <h3 className="mt-2 text-[18px] font-semibold">$1599</h3>
                  <h3 className="mt-2 text-sm text-[#A3A3A3] line-through font-normal">
                    $1999
                  </h3>
                  <button className="bg-[#023E8A] font-medium w-full rounded-lg text-white text-sm mt-5 py-3 text-center flex items-center justify-center space-x-2">
                    <span>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
